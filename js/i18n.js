document.addEventListener('DOMContentLoaded', function () {
  const translations = {
    ...
    en: {      'nav.home': 'Home',
      ...
      'footer.aboutText': '<span style="color: #E6C07A">BONO Piano Akustik</span> stands for natural sound damping for grand and upright pianos. The product combines hands-on musical experience with premium materials and precise craftsmanship - delivering uncompromising tone at a reduced sound level. Invented by concert pianist, theatre musician and piano teacher <b>Nataliya Tkachenko</b>, <span style="color: #E6C07A">BONO Piano Akustik</span> brings together musical expertise and the know-how of Chinese specialists in acoustic material technology. We continuously refine our product to combine top quality with efficient manufacturing. <br><span style="font-size: 1.4rem;"><b><em>For the love of music!</em></b></span>',
      'footer.nav': 'Navigation',
      ...
      'product.feature1.text': 'Open grand pianos offer outstanding sound, but in small rooms they are often simply too loud. BONO Piano Akustik provides a practical way to keep the character of the instrument while reducing volume where needed.',
      'product.feature2.title': '<b>Product & How It Works</b>',
      'product.feature2.text': 'The damping system is mounted inside the piano lid, is removable without residue, and can be adjusted depending on the room and playing situation.',
      'product.feature3.title': '<b>Reports & Measurements</b>',
      'product.feature3.text': 'Independent measurements confirm a clearly audible and measurable reduction in sound emissions with BONO Piano Akustik.',
      ...
      'product.table80.row1.without': '2 h 22 min',
      'product.table80.row1.with': '4 h 56 min',
      'product.table80.row2.without': '3 h 55 min',
      'product.table80.row2.with': '5 h 56 min',
      'product.table85.row1.without': '7 h 28 min',
      'product.table85.row1.with': '15 h 36 min',
      'product.table85.row2.without': '12 h 23 min',
      'product.table85.row2.with': '18 h 41 min',
    ...
    zh: {      'nav.home': '首页',
      ...
      'card.youtubeVid': '<b>亲自体验这款声学效果！</b><br><br>在本视频中，Bono Piano Akustik 的发明者兼创始人 Nataliya Tkachenko 演奏了 Satie 的 <em>Gnossienne 第一号</em>，并安装了消音器。这可以显著降低音量，同时保持自然的音色特性。',
      'footer.about': '关于我们',
      ...
      'product.feature1.text': '打开琴盖的三角钢琴音色出众，但在较小空间中往往音量过大。BONO Piano Akustik 能在保留自然音色特征的同时，按需降低音量。',
      ...
      'product.feature2.text': '该降噪系统安装在琴盖内部，可无残留拆卸，并可根据空间与演奏场景灵活调整。',
      'product.feature3.title': '<b>报告与测量</b>',
      'product.feature3.text': '独立测量结果证实：使用 BONO Piano Akustik 后，声发射可实现清晰可闻且可量化的降低。',
      ...
      'product.table80.row1.without': '2 小时 22 分',
      'product.table80.row1.with': '4 小时 56 分',
      'product.table80.row2.without': '3 小时 55 分',
      'product.table80.row2.with': '5 小时 56 分',
      'product.table85.row1.without': '7 小时 28 分',
      'product.table85.row1.with': '15 小时 36 分',
      'product.table85.row2.without': '12 小时 23 分',
      'product.table85.row2.with': '18 小时 41 分',
      'tutorial.title': '教程',
